...
int SnakeGame::Initialize()
{
	...
	g_pResourceManager->LoadTexture("Assets/Textures/block.png", "block");
        ...
        g_pResourceManager->LoadTexture("Assets/Textures/mine.png","mine");
	...
	std::shared_ptr<Scene> Level0 = std::make_shared<Scene>("Level0");
  	...
  	std::shared_ptr<SnakeGameLevel> GameLevel = std::make_shared<SnakeGameLevel>();
        GameLevel->Load("Assets/Level/SnakeGame/level0.lvl", gConfig->GetWidth(), gConfig->GetHeight());
